...
public class TestMaximumProblem {
    ...
    @Test
    public void givenStringValue_MaxAtFirstPlaceAsDynamicParameters_ShouldReturnMaximumValue1() {
        Assert.assertEquals("Ranga",MaximumProblem.testMaximum( "Apple","Ranga"));
    }
    @Test
